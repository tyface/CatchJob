...
//		public static final String HOST = "http://catchjob.mooo.com"; 
	...
	public static class File{
		public static final String JOIN = "resources/mail-template/join-mail.html"; //회원가입 메일 탬플릿
		...
		public static final String IMG_SUCSSES = "resources/img/sucsess-img.gif"; 
		public static final String IMG_LOGO_1 = "resources/img/logo-name.png"; 
	}
	...
	public static class Interview{
		public static final int NUM_OF_ITVW_PER_PAGE = 2; //view 페이지에서 화면에 표시할 row 수
	...
	public static class Recent{
		public static final int NUM_OF_RECENT_PER_PAGE = 10; //[마이페이지 > recent]에서 화면에 표시할 row 수
	}
