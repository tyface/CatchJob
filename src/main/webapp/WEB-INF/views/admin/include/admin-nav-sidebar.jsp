			...
			<ul class="list-unstyled components" style="margin-top: 50px">
				<li><a href="#pageSubmenu1" data-toggle="collapse"
					...
					<ul class="collapse list-unstyled" id="pageSubmenu1">
						<li><a
							href="${pageContext.request.contextPath}/admin/mngMber">회원 그룹</a>
						</li>
						<li><a
							href="${pageContext.request.contextPath}/admin/mngAdmin">관리자
								그룹</a></li>
					</ul></li>
				<li><a href="#pageSubmenu2" data-toggle="collapse"
					...
					<ul class="collapse list-unstyled" id="pageSubmenu2">
						<li><a href="${pageContext.request.contextPath}/admin/mngEnt">기업
								관리</a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/mngReview">리뷰
								관리</a></li>
					</ul></li>
