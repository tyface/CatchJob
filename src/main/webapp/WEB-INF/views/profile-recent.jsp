...
<article class="container">
	<div class="contents-wrap">
	  ...
	  <h1>최근 본 기업</h1>
	  		<c:forEach begin="0" varStatus="status" end="9" var="recent" items="${recentView}">
			<div class="row ent-list">
	
				<div class="col-sm-8">
					<div class="row">
						<a href="enterprise/view?entIndex=${recent.entIndex}" class="p25">${recent.entName}</a>
				...
				<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-xs-6 text-center cell-1">
							...
							<a href="${contextPath}/enterprise/view?entIndex=${recent.entIndex}#section2"><br>리뷰코멘트</a>
						</div>
						<div class="col-xs-6 text-center cell-2">
							<strong>${recent.interviewCount}</strong>
							<a href="${contextPath}/enterprise/view?entIndex=${recent.entIndex}#section3"><br>면접정보</a>
						</div>
					</div>
				</div>
