...
<body>
	...
	<div class="container text-center bg-grey">
		...
		<div class="row text-center">
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="//src/main/webapp/WEB-INF/img/paris.jpg" alt="Paris" width="400" height="300">
					<p>
						<strong>Paris</strong>
					</p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="/src/main/webapp/WEB-INF/img/newyork.jpg" alt="New York" width="400" height="300">
					<p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="src/main/webapp/WEB-INF/img/sanfran.jpg" alt="San Francisco" width="400" height="300">
					<p>
...
<!-- <div class="container jumbotron text-center" style="color: #000000;background-color: #FFFFFF;"> -->
<div class="container jumbotron text-center" >
